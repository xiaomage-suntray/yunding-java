...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        filterMap.put("/sys/ssoLogin", "anon");
        ...
        filterMap.put("/sysFlowManagement/upload", "anon");
        filterMap.put("/create", "anon");
        filterMap.put("/modelList", "anon");
        filterMap.put("/getMmodelList", "anon");
        filterMap.put("/getDeploymentList", "anon");
        filterMap.put("/**.html", "anon");
        filterMap.put("/editor-app/**", "anon");
        filterMap.put("/diagram-viewer/**", "anon");
        filterMap.put("/service/**", "anon");
        filterMap.put("/websocket/commodity/**", "anon");
