...
@ApiModel(value = "组织机构管理对象", description = "组织机构管理对象") //swagger注解
@TableName("sys_org") //mybatisplus注解
public class SysOrg implements Serializable {
    ...
    @ApiModelProperty(value = "id", name = "orgId")
    @TableId
    ...
    @ApiModelProperty(value = "是否公司", name = "isCorporation")
    private java.lang.String isCorporation;
